...
//  Serial.print(flag_slosh);
  if(cap4>slosh_lim && flag_auto && !flag_slosh && !flag_stop) {flag_auto = 0; flag_slosh = 1;}
  else if(cap4<stop_slosh_lim && flag_auto && flag_slosh) flag_slosh = 0;
  else if(cap4<safe_slosh_lim && flag_slosh == 1 && !flag_auto) {flag_auto = 1;flag_slosh = 0;}
