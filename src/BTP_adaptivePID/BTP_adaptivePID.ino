...
/* code for tuning velocity control
  ...
  Added fuzzy (new library)*/
// #it is not tuned (1st feb)
//===============================================================
#include <XBOXUSB.h>
#include <Fuzzy_lib_v8_commented.h>
...
double kp= 1,kd = 3;//3,6
double kp_d= 4,kd_d = 0.1;
...
//  vel.get_membership(2.4*70 , 2.3*15 , 125.0, 0.0);//2.4 * 15, 2.3 * 5, 125.0, 0.0
