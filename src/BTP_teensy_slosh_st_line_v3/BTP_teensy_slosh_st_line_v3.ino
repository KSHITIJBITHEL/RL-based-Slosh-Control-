...
/* code with implementation of Obstacle avoidance in adition with
the features of the straight line motion with velocity control,
also includes the calculation of velocity*/
