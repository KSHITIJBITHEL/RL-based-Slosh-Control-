...
// ================================================================
void calibrate (){
    static float sum_yaw = 0, sum_pitch = 0, sum_roll = 0, sum_accl_x = 0, sum_accl_y = 0, sum_accl_z = 0;
...
//    sum_roll = sum_roll + ypr[2];
    ...
    yaw_offset = sum_yaw/100.0;
//    pitch_offset = sum_pitch/10.0;
//    roll_offset = sum_roll/10.0;
    acc_x_offset = sum_accl_x/100.0;
    acc_y_offset = sum_accl_y/100.0;
    acc_z_offset = sum_accl_z/100.0-9800;
    print_gyro_offsets();
}
// ================================================================
...
void got_intr(){
    ...
    // otherwise, check for DMP data ready interrupt (this should happen frequently)
        ...
        fifoCount -= packetSize;
            ...
            mpu.dmpGetAccel(accl,fifoBuffer);
