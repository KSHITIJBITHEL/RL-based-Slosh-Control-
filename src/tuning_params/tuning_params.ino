...
USB Usb;
XBOXUSB Xbox(&Usb);
int pwm_front_right, pwm_front_left,base_pwm = 0;
int pwm_back_right, pwm_back_left, k = 10;
bool flag_auto = 0,flag_print = 1, flag_slosh = 0,flag_stop=0, incr = 1;
double kp= 3,kd = 6;
double kp_d= 4,kd_d = 0.3;
double kp_v= 5,kd_v = 1, ki_v= 0.25;
...
int strength1,strength2, des_angle = 0; //signal strength of LiDAR
