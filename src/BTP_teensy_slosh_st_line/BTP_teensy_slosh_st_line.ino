...
bool flag_auto = 0,flag_print = 0, flag_slosh = 0;
double kp= 2,kd = 0;
...
float cap1,cap2,cap3,cap4, x, y,slosh_lim = 3, safe_slosh_lim = 1.5;
...
//==================================================================
  ...
  while (!mpuInterrupt && fifoCount < packetSize) {
    ...
    read_lidar1();
    read_lidar2();
//    Serial.println("yaha aya");
//    slosh_xy();
//    Serial.println("yaha aya2");
